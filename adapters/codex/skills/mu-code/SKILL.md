...
2. Apply references/devmuse/knowledge/principles/git-safety.md before branch operations.
...
Apply references/devmuse/knowledge/principles/git-safety.md and run the relevant baseline
...
`parallel-dispatch.md`. All other tasks run sequentially.
...
read `testing-anti-patterns.md` before writing that test branch.
