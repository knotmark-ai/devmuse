...
Read `references/devmuse/knowledge/principles/project-context.md`. Run `resolve`, then
...
`references/devmuse/knowledge/principles/case-registry.md`; closing this scope never deletes
