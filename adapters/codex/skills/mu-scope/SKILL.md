...
references/devmuse/knowledge/principles/artifact-succession.md. Write the Use Case Set to
`docs/scope/YYYY-MM-DD-<name>.md` using references/devmuse/knowledge/templates/scope.md and
references/devmuse/knowledge/principles/prose-discipline.md.
