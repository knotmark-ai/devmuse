...
9. **Assemble _index.md** — use the template at `references/devmuse/knowledge/templates/wiki-index.md`. Fill in:
...
Write the wiki page to: docs/wiki/{page_id}.md — drafted per references/devmuse/knowledge/principles/prose-discipline.md
...
- **Template:** `references/devmuse/knowledge/templates/wiki-index.md`
- **Shared knowledge:** `references/devmuse/knowledge/principles/architecture-assessment.md` (C4 model reference, diagram types, Mermaid examples)
