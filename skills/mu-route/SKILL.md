...
**On-demand skills (mu-biz, mu-prd, mu-retro, mu-wiki, mu-grill) are not auto-routed.** mu-route responds with a pointer to the appropriate slash command instead of invoking the skill.
