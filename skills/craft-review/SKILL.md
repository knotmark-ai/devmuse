...
Use Task tool with craft-claude:craft-reviewer type, fill template at `craft-reviewer.md`
...
[Dispatch craft-reviewer subagent]
  ...
  PLAN_OR_REQUIREMENTS: Task 2 from docs/craft-claude/plans/deployment-plan.md
  BASE_SHA: a7981ec
  HEAD_SHA: 3df7661
...
See template at: craft-review/craft-reviewer.md
