...
Add two new review stages to the craft-claude workflow:
...
**Location:** `skills/craft-brainstorm/spec-document-reviewer-prompt.md`
...
**Location:** `skills/craft-plan/plan-document-reviewer-prompt.md`
...
**New files:**
- `skills/craft-brainstorm/spec-document-reviewer-prompt.md`
- `skills/craft-plan/plan-document-reviewer-prompt.md`

**Modified files:**
- `skills/craft-brainstorm/SKILL.md` - add review loop after spec written
- `skills/craft-plan/SKILL.md` - add chunk-by-chunk review loop, update task syntax examples
