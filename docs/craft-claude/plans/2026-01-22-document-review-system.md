...
> **For agentic workers:** REQUIRED: Use craft-claude:craft-sdd (if subagents available) or craft-claude:craft-execute to implement this plan.
...
**Spec:** docs/craft-claude/specs/2026-01-22-document-review-system-design.md
...
**Files:**
- Create: `skills/craft-brainstorm/spec-document-reviewer-prompt.md`
...
**Dispatch after:** Spec document is written to docs/craft-claude/specs/
...
Run: `cat skills/craft-brainstorm/spec-document-reviewer-prompt.md | head -20`
Expected: Shows the header and purpose section

- [ ] **Step 3:** Commit

```bash
git add skills/craft-brainstorm/spec-document-reviewer-prompt.md
...
Run: `cat skills/craft-brainstorm/SKILL.md`
...
Run: `grep -A 15 "Spec Review Loop" skills/craft-brainstorm/SKILL.md`
Expected: Shows the new review loop section

- [ ] **Step 4:** Commit

```bash
git add skills/craft-brainstorm/SKILL.md
...
**Files:**
- Create: `skills/craft-plan/plan-document-reviewer-prompt.md`
...
Run: `cat skills/craft-plan/plan-document-reviewer-prompt.md | head -20`
Expected: Shows the header and purpose section

- [ ] **Step 3:** Commit

```bash
git add skills/craft-plan/plan-document-reviewer-prompt.md
...
Run: `cat skills/craft-plan/SKILL.md`
...
Run: `grep -A 15 "Plan Review Loop" skills/craft-plan/SKILL.md`
Expected: Shows the new review loop section

- [ ] **Step 5:** Verify the task syntax examples were updated

Run: `grep -A 5 "Task N:" skills/craft-plan/SKILL.md`
...
Run: `grep -A 20 "Plan Document Header" skills/craft-plan/SKILL.md`
...
```markdown
> **For agentic workers:** REQUIRED: Use craft-claude:craft-sdd (if subagents available) or craft-claude:craft-execute to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```

- [ ] **Step 3:** Verify the change

Run: `grep -A 5 "For agentic workers:" skills/craft-plan/SKILL.md`
