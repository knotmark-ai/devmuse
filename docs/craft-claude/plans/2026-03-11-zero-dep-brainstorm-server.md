...
> **For agentic workers:** REQUIRED: Use craft-claude:craft-sdd (if subagents available) or craft-claude:craft-execute to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.
...
**Spec:** `docs/craft-claude/specs/2026-03-11-zero-dep-brainstorm-server-design.md`
...
- **Create:** `skills/craft-brainstorm/scripts/server.js` — the zero-dep replacement
- **Modify:** `skills/craft-brainstorm/scripts/start-server.sh:94,100` — change `index.js` to `server.js`
- **Modify:** `.gitignore:6` — remove the `!skills/craft-brainstorm/scripts/node_modules/` exception
- **Delete:** `skills/craft-brainstorm/scripts/index.js`
- **Delete:** `skills/craft-brainstorm/scripts/package.json`
- **Delete:** `skills/craft-brainstorm/scripts/package-lock.json`
- **Delete:** `skills/craft-brainstorm/scripts/node_modules/` (714 files)
- **No changes:** `skills/craft-brainstorm/scripts/helper.js`, `skills/craft-brainstorm/scripts/frame-template.html`, `skills/craft-brainstorm/scripts/stop-server.sh`
...
**Files:**
- Create: `skills/craft-brainstorm/scripts/server.js`
...
```bash
git add skills/craft-brainstorm/scripts/server.js
...
**Files:**
- Modify: `skills/craft-brainstorm/scripts/server.js`
...
**Files:**
- Modify: `skills/craft-brainstorm/scripts/start-server.sh:94,100`
- Modify: `.gitignore:6`
- Delete: `skills/craft-brainstorm/scripts/index.js`
- Delete: `skills/craft-brainstorm/scripts/package.json`
- Delete: `skills/craft-brainstorm/scripts/package-lock.json`
- Delete: `skills/craft-brainstorm/scripts/node_modules/` (entire directory)
...
In `.gitignore`, delete line 6: `!skills/craft-brainstorm/scripts/node_modules/`

- [ ] **Step 3: Delete old files**

```bash
git rm skills/craft-brainstorm/scripts/index.js
git rm skills/craft-brainstorm/scripts/package.json
git rm skills/craft-brainstorm/scripts/package-lock.json
git rm -r skills/craft-brainstorm/scripts/node_modules/
```
...
```bash
git add skills/craft-brainstorm/scripts/ .gitignore
...
```bash
cd skills/craft-brainstorm/scripts
