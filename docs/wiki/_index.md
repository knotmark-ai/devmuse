...
> **Baseline commit:** `2ee5b19374de17cf60f3c04a1d747f780e0a8335`
...
| [按需技能：mu-biz / mu-prd / mu-wiki / mu-retro / mu-grill](on-demand-skills.md) | ✅ | skills/mu-biz/SKILL.md, skills/mu-prd/SKILL.md, skills/mu-wiki/SKILL.md, skills/mu-retro/SKILL.md, skills/mu-grill/SKILL.md, knowledge/principles/grilling.md, knowledge/principles/premise-check.md, knowledge/principles/state-modeling.md |
...
| [测试基础设施](testing-infrastructure.md) | ✅ | docs/testing.md, tests/claude-code/README.md, tests/claude-code/run-skill-tests.sh, tests/skill-triggering/run-all.sh, tests/explicit-skill-requests/run-all.sh, tests/hooks/test-pipeline-gate.sh, knowledge/principles/skill-testing.md, tests/prd-state-modeling/README.md, tests/prd-state-modeling/run-test.sh |
...
|------|--------|--------|---------------|
| 2026-07-26 | `2ee5b19` | update | 6 pages regenerated after the v1.3.0 state-modeling release (PR #38): on-demand-skills (mu-prd Product Object Model + state-modeling.md added to relevant_files), core-pipeline (state vocabulary inheritance), workflow-and-routing (SKILL-ROUTING de-coercion), four-layer-architecture (v1.3.0, devmuse-bootstrap tag), hooks-and-gates (session-start tag), testing-infrastructure (prd-state-modeling suite added to relevant_files). docs-maintenance-contract excluded per user (README role-line change only). |
