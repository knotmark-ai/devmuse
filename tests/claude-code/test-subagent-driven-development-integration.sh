...
mkdir -p src test docs/craft-claude/plans

# Create a simple implementation plan
cat > docs/craft-claude/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/craft-claude/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from craft-claude directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/craft-claude/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"craft-claude:craft-sdd"' "$SESSION_FILE"; then
